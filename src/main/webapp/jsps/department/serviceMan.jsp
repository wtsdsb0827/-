...
<div id="app">
    <div style="margin-top:50px;margin-left: 50px; ">
        <template>
            ...
            <template>
                所属公司：<el-select v-model="value1" placeholder="全部">
                <el-option
            ...
            <template>
                品类：<el-select v-model="value2" placeholder="全部">
                <el-option
                        v-for="item in options"
                        :key="item.value"
                        :label="item.label"
            ...
            <template>
                省：<el-select v-model="value3" placeholder="全部">
                <el-option
                        v-for="item in options"
                        :key="item.value"
                        :label="item.label"
                ...
                市：<el-select v-model="value4" placeholder="全部">
                <el-option
                        v-for="item in options"
                        :key="item.value"
                        :label="item.label"
                ...
                区：<el-select v-model="value5" placeholder="全部">
                <el-option
                        v-for="item in options"
                        :key="item.value"
                        :label="item.label"
            ...
            <template>
                状态：<el-select v-model="value6" placeholder="全部">
                <el-option
                        v-for="item in options"
                        :key="item.value"
                        :label="item.label"
